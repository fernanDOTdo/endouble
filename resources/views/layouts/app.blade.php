...
<head>
    ...
    <title>Endouble Test - @yield('title')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    @if (Auth::check())
                        <li class="dropdown">
                            <a href="{{ url('/vacancies') }}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                Vacancies <span class="caret"></span>
                            </a>
